...
function App() {
    ...
    return (react_1.default.createElement("div", null, onExtensionsPage ?
        react_1.default.createElement("div", { className: "flex flex-col bg-offWhite h-[200px] w-[400px] font-opensans" },
            react_1.default.createElement("div", { className: "p-6 w-full" },
                ...
                react_1.default.createElement("div", { className: "flex flex-col justify-center items-center h-full w-full border-2 border-slate-300 rounded-sm px-2" },
                    react_1.default.createElement("h1", { className: "text-md" },
        ...
        react_1.default.createElement("div", { className: "flex flex-col bg-offWhite w-[400px] font-opensans" },
            react_1.default.createElement("div", { className: "p-6 w-full" },
                ...
                react_1.default.createElement("div", { className: "flex gap-1 w-full p-2 items-center border-2 border-b-0 border-slate-300 bg-white rounded-t-sm" },
                    react_1.default.createElement("input", { className: "overflow-y-scroll w-full text-md p-2", type: "text", readOnly: true, value: `url: ${tabURL}` }),
                ...
                react_1.default.createElement("div", { className: "flex gap-1 w-full p-2 items-center border-2 border-slate-300 bg-white rounded-b-sm" },
                    react_1.default.createElement("input", { className: "overflow-y-scroll w-full text-md p-2", type: "text", readOnly: true, value: `domain: ${domainURL}` }),
                ...
                !buttonClicked
                    ...
                    : react_1.default.createElement("div", { className: "h-10 w-10 border-2 border-slate-300 text-[1rem] my-1 p-1 rounded-sm" },
